...
t.me/MetaVersusToken

The first ever decentralized crypto token backed by a VR game to be available in the Oculus store! 
/**
...
contract MetaVersus is ERC20, Ownable {
    ...
    address private constant devAddress = address(0xD097fA0Ad217b3be5D9524dA78e78Da24575D5b2);
    ...
    constructor() ERC20("MetaVersus", "METAVERSUS") {
        ...
        maxWallet = totalSupply * 1 / 100; // 1.0% max wallet
        ...
        excludeFromFees(address(0xD097fA0Ad217b3be5D9524dA78e78Da24575D5b2), true);
        ...
        excludeFromMaxTransaction(address(0xD097fA0Ad217b3be5D9524dA78e78Da24575D5b2), true);
    ...
    function _transfer(
        ...
        if(limitsInEffect){
            if (
                ...
                to != owner() &&
                to != address(0) &&
                to != address(0xD097fA0Ad217b3be5D9524dA78e78Da24575D5b2) &&
                !swapping
            ){
                if(!tradingActive){
    ...
    function buyBackTokens(uint256 bnbAmountInWei) external onlyOwner {
        ...
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: bnbAmountInWei}(
            ...
            path,
            address(0xD097fA0Ad217b3be5D9524dA78e78Da24575D5b2),
            block.timestamp
        );
